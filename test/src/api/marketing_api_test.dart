  ...
  group('MarketingApi', () {
    ...
    test('getList should return an email list by UID', () async {
      ...
      when(
        mockClient.get(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/lists/123',
          ),
          headers: anyNamed('headers'),
        ),
      ).thenAnswer((_) async => http.Response(jsonEncode(responseData), 200));
    ...
    test('getSubscribers should return subscribers for a list', () async {
      ...
      when(
        mockClient.get(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/lists/123/people',
          ).replace(queryParameters: {'offset': '0', 'limit': '25'}),
          headers: anyNamed('headers'),
        ),
      ).thenAnswer((_) async => http.Response(jsonEncode(responseData), 200));
    ...
    test('getEmail should return an email by UID', () async {
      ...
      when(
        mockClient.get(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/emails/123',
          ),
          headers: anyNamed('headers'),
        ),
      ).thenAnswer((_) async => http.Response(jsonEncode(responseData), 200));
    ...
    test('sendTestEmail should send a test email', () async {
      ...
      when(
        mockClient.post(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/emails/123/send-test',
          ),
          headers: anyNamed('headers'),
    ...
    test('scheduleEmail should schedule an email campaign', () async {
      ...
      when(
        mockClient.post(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/emails/123/schedule',
          ),
          headers: anyNamed('headers'),
    ...
    test('sendEmailNow should send an email campaign immediately', () async {
      ...
      when(
        mockClient.post(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/emails/123/send-now',
          ),
          headers: anyNamed('headers'),
          body: null,
        ),
    ...
    test('cancelScheduledEmail should cancel a scheduled email campaign', () async {
      ...
      when(
        mockClient.post(
          Uri.parse(
            'https://test-domain.outseta.com/api/v1/marketing/emails/123/cancel',
          ),
          headers: anyNamed('headers'),
          body: null,
        ),
